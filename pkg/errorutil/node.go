...
func isNewCallExpr(node ast.Node) (*Error, bool) {
	empty := &Error{}
	if ce, ok := node.(*ast.CallExpr); ok {
...
func handleValueSpec(n ast.Node, update bool, updateAll bool, comp *Info, logger *slog.Logger, path string, infoAll *InfoAll) bool {
