...
var (
	...
	ErrPodHasNoLabels = errors.NewErrorDescription(ErrPodHasNoLabelsCode, errors.Alert, []string{"the pod has no labels and cannot be exposed"}, []string{}, []string{}, []string{})

	// ErrServiceHasNoSelectors is the error for service with no selectors
	ErrServiceHasNoSelectors = errors.NewErrorDescription(ErrServiceHasNoSelectorsCode, errors.Alert, []string{"the service has no pod selector set"}, []string{}, []string{}, []string{})

	// ErrInvalidDeploymentNoSelectorsLabels is the error for deployment (v1beta1) with no selectors and labels
	ErrInvalidDeploymentNoSelectorsLabels = errors.NewErrorDescription(ErrInvalidDeploymentNoSelectorsLabelsCode, errors.Alert, []string{"the deployment has no labels or selectors and cannot be exposed"}, []string{}, []string{}, []string{})

	// ErrInvalidDeploymentNoSelectors is the error for deployment (v1) with no selectors
	ErrInvalidDeploymentNoSelectors = errors.NewErrorDescription(ErrInvalidDeploymentNoSelectorsCode, errors.Alert, []string{"invalid deployment: no selectors, therefore cannot be exposed"}, []string{}, []string{}, []string{})

	// ErrInvalidReplicaNoSelectorsLabels is the error for replicaset (v1beta1) with no selectors and labels
	ErrInvalidReplicaNoSelectorsLabels = errors.NewErrorDescription(ErrInvalidReplicaNoSelectorsLabelsCode, errors.Alert, []string{"the replica set has no labels or selectors and cannot be exposed"}, []string{}, []string{}, []string{})

	// ErrInvalidReplicaSetNoSelectors is the error for replicaset (v1) with no selectors
	ErrInvalidReplicaSetNoSelectors = errors.NewErrorDescription(ErrInvalidReplicaSetNoSelectorsCode, errors.Alert, []string{"invalid replicaset: no selectors, therefore cannot be exposed"}, []string{}, []string{}, []string{})

	// ErrNoPortsFoundForHeadlessResource is the error when no ports are found for non headless resource
	ErrNoPortsFoundForHeadlessResource = errors.NewErrorDescription(ErrNoPortsFoundForHeadlessResourceCode, errors.Alert, []string{"no ports found for the non headless resource"}, []string{}, []string{}, []string{})
)
...
func ErrUnknownSessionAffinityErr(sa SessionAffinity) error {
	return errors.NewErrorDescription(ErrUnknownSessionAffinityErrCode, errors.Alert, []string{"unknown session affinity:", string(sa)}, []string{}, []string{}, []string{})
}
...
func ErrMatchExpressionsConvertionErr(me []metav1.LabelSelectorRequirement) error {
	return errors.NewErrorDescription(ErrMatchExpressionsConvertionErrCode, errors.Alert, []string{"couldn't convert expressions - to map-based selector format"}, []string{}, []string{}, []string{})
}
...
func ErrFailedToExtractPodSelectorErr(object runtime.Object) error {
	return errors.NewErrorDescription(ErrFailedToExtractPodSelectorErrCode, errors.Alert, []string{"cannot extract pod selector from ", object.GetObjectKind().GroupVersionKind().Kind}, []string{}, []string{}, []string{})
}

// ErrFailedToExtractPorts is the error for failed to extract ports
func ErrFailedToExtractPorts(object runtime.Object) error {
	return errors.NewErrorDescription(ErrFailedToExtractPortsCode, errors.Alert, []string{"cannot extract ports from ", object.GetObjectKind().GroupVersionKind().Kind}, []string{}, []string{}, []string{})
}
...
func ErrFailedToExtractProtocolsErr(object runtime.Object) error {
	return errors.NewErrorDescription(ErrFailedToExtractProtocolsErrCode, errors.Alert, []string{"cannot extract protocols from ", object.GetObjectKind().GroupVersionKind().Kind}, []string{}, []string{}, []string{})
}
...
func ErrCannotExposeObjectErr(kind schema.GroupKind) error {
	return errors.NewErrorDescription(ErrCannotExposeObjectErrCode, errors.Alert, []string{"cannot expose a ", kind.String()}, []string{}, []string{}, []string{})
}
...
func ErrExposeResource(err error) error {
	return errors.NewErrorDescription(ErrExposeResourceCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}
...
func ErrGettingResource(err error) error {
	return errors.NewErrorDescription(ErrGettingResourceCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}
...
func ErrTraverser(err error) error {
	return errors.NewErrorDescription(ErrTraverserCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}
...
func ErrResourceCannotBeExposed(err error, resourceKind string) error {
	return errors.NewErrorDescription(ErrResourceCannotBeExposedCode,
...
func ErrSelectorBasedMap(err error) error {
	return errors.NewErrorDescription(ErrSelectorBasedMapCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}

// ErrProtocolBasedMap is the error when the given resource's protocols can't
// be parsed to a map
func ErrProtocolBasedMap(err error) error {
	return errors.NewErrorDescription(ErrProtocolBasedMapCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}

// ErrLabelBasedMap is the error when the given resource's labels can't
// be parsed to a map
func ErrLabelBasedMap(err error) error {
	return errors.NewErrorDescription(ErrLableBasedMapCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}

// ErrPortParsing is the error when the given resource's ports can't
// be parsed to a slice
func ErrPortParsing(err error) error {
	return errors.NewErrorDescription(ErrPortParsingCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}

// ErrGenerateService is the error when a service cannot be generated
// for the given resource
func ErrGenerateService(err error) error {
	return errors.NewErrorDescription(ErrGenerateServiceCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}
...
func ErrConstructingRestHelper(err error) error {
	return errors.NewErrorDescription(ErrConstructingRestHelperCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}

// ErrCreatingService is the error when there is an error deploying the service
func ErrCreatingService(err error) error {
	return errors.NewErrorDescription(ErrCreatingServiceCode, errors.Alert, []string{err.Error()}, []string{}, []string{}, []string{})
}
